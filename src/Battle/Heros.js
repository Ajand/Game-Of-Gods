...
export default [
  {
    ...
    abilities: [
      ...
      },
      {
        name: "Pegasus Charge",
        description:
          "Zeus commands Pegasus to charge at the enemy, stunning one ability for 2 rounds",
        active: true,
        variant: "debuff",
        debuffVariant: "stun",
        rounds: 2,
